...
> - Memory: ~128MB of available RAM (as in, not used by the operating system)
...
> [!NOTE]  
> Memory usage is affected by how many cores your processor has. A multi-core system can easily reach 100MB of memory usage, while a single-core system with a low render distance can use as little as 20MB
