...
| ------------------------------------------------------------------------------------------------------------------ | ------------ | -------------------------------------------------- | ----------------------------------------------- | ----------------- | ------------------------ | ------------------------------ | ------------ |
| [`7b80726`](https://github.com/OfficialPixelBrush/BetrockPlusPlus/commit/7b80726785d85d5441b2e7bf1e05e18321b2bf45) | x86 (i586)   | Gentoo Linux i586 (Linux 7.1.5)                    | AMD-K5(tm) @ 100MHz                             | 32 MB             | 4GB (swap)               |                                | Pixel Brush  |
| [`7b80726`](https://github.com/OfficialPixelBrush/BetrockPlusPlus/commit/7b80726785d85d5441b2e7bf1e05e18321b2bf45) | x86 (i686)   | Gentoo Linux i686 (Linux 7.1.5)                    | Pentium II (Deschutes) @ 337 GHz                | 128 MB            | 4GB (swap)               | Lifetec (modified)             | Pixel Brush  |
...
## Recommended Specs (Client)

The client is too WIP to really say anything concrete about, however, our rendering engine `sokol`, requires either **Vulkan 1.0**, **Metal**, **DirectX 11** or **OpenGL 3.3** support.

## Recommended Specs (Server)
